...
import photoMonsera1Image from "../assets/social-media/monsera-1.jpg";
import photoMonsera2Image from "../assets/social-media/monsera-2.jpg";
import photoMonsera3Image from "../assets/social-media/monsera-3.jpg";
import photoMonsera4Image from "../assets/social-media/monsera-4.jpg";
import photoMonsera5Image from "../assets/social-media/monsera-5.jpg";
import photoMonsera6Image from "../assets/social-media/monsera-6.jpg";
import photoRagamRasa1Image from "../assets/social-media/ragam-rasa-1.jpg";
import photoRagamRasa2Image from "../assets/social-media/ragam-rasa-2.jpg";
...
export default function SocialMedia3Section({
  isTransitioning,
  setIsTransitioning,
  activePage,
  setActivePage,
  ...
  const windowSmallRef = useRef<HTMLDivElement | null>(null);
  ...
  const socialMediaPosts2 = [photoRagamRasa1Image, photoRagamRasa2Image, photoMonsera1Image];
  ...
  const getParallaxLayers = () => [
    ...
    { ref: windowSmallRef, x: layerMotion.skill, y: layerMotion.skill },
  ...
  useEffect(() => {
    if (firstRender.current) {
      ...
      gsap.set(windowSmallRef.current, {
        yPercent: 50,
      });
    ...
    if (activePage.current == "social-media-3") {
      ...
      timeline
        ...
        .to(windowSmallRef.current, {}, `-=${TRANSITION_DURATION}`)
  ...
  const handleBackToWelcome = () => {
    ...
    setActivePage({ current: "welcome", before: "social-media-3" });
    ...
    timeline
      ...
      .to(windowSmallRef.current, { yPercent: 100 }, `-=${TRANSITION_DURATION}`)
  ...
  const handleToMore = (page: string) => {
    ...
    containerRef.current?.removeEventListener("mousemove", handleMouseMove);
    containerRef.current?.removeEventListener("mouseleave", handleMouseLeave);
    setActivePage({ current: page, before: "social-media-3" });
    setIsTransitioning(true);
    ...
    timeline
      ...
      .to(windowSmallRef.current, { xPercent: 78 }, `-=${TRANSITION_DURATION}`)
