...
import photoFacial1Image from "../assets/social-media/facial-1.jpg";
import photoFacial2Image from "../assets/social-media/facial-2.jpg";
import photoFacial3Image from "../assets/social-media/facial-3.jpg";
import photoFacial4Image from "../assets/social-media/facial-4.jpg";
import photoFacial5Image from "../assets/social-media/facial-5.jpg";
import photoFacial6Image from "../assets/social-media/facial-6.jpg";
...
export default function SocialMedia2Section({
  isTransitioning,
  setIsTransitioning,
  activePage,
  setActivePage,
  ...
  useEffect(() => {
    ...
    if (activePage.current == "social-media-2") {
  ...
  const handleBackToWelcome = () => {
    ...
    setActivePage({ current: "welcome", before: "social-media-2" });
  ...
  const handleToMore = (page: string) => {
    ...
    containerRef.current?.removeEventListener("mousemove", handleMouseMove);
    containerRef.current?.removeEventListener("mouseleave", handleMouseLeave);
    setActivePage({ current: page, before: "social-media-2" });
    setIsTransitioning(true);
  ...
  return (
    <section
      ...
      className={`absolute flex justify-center items-center inset-0 transition-colors duration-500 ${
        activePage.current !== "social-media-2" ? "pointer-events-none" : ""
      }`}
    >
      {/* menjaga rasio 16:9 */}
      <div className={`relative aspect-video ${aspectFitClassName}`}>
        ...
        <div ref={introWindowRef} className={`absolute right-[20%] top-[41.5%] z-20 w-[30cqh]`}>
          <p className="inter-font text-[1.5cqh] leading-[1.22] tracking-[-0.02em] text-primary-400/95">
            ...
            the design of their beauty brand, namely "Miracle" specifically for the Manado branch.
            This design result uses Photoshop, Illustrator and Canva software (if needed)
          </p>
        </div>
