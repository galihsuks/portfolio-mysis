  ...
  return (
    ...
    >
      ...
      <div className="h-full relative aspect-video mx-auto">
        ...
        <div
          ref={introWindowRef}
          className="absolute left-[50%] bottom-[65%] z-20 w-[20rem] max-w-[21vw]"
        >
        ...
        <div ref={skillRef} className="absolute right-[55%] top-[5%] z-21">
          <Window
            isMobile={isMobile}
            size="custom"
            panelClassName="bg-secondary-900/52"
          ...
          >
            ...
            <img
              ...
              className={`block h-[50svh] ${isMobile ? "rounded-[6px]" : "rounded-[1.1rem]"} object-cover`}
            />
        ...
        <div ref={experienceRef} className="absolute right-[20%] top-[40%] z-22">
          <Window
            isMobile={isMobile}
            size="custom"
            panelClassName="bg-secondary-900/52"
        ...
        <div className={`absolute bottom-[9.8%] z-20 ${isMobile ? "right-[0%]" : "right-[8.7%]"}`}>
          <button
            ...
            className="inter-font text-[3svh] tracking-[-0.03em] text-primary-400/70 mb-10 border-b border-transparent hover:border-primary-400 cursor-pointer"
          >
            Video
          </button>
