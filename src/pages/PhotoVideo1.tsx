  ...
  return (
    ...
    >
      ...
      <div className={`relative aspect-video ${aspectFitClassName}`}>
        ...
        <div ref={introWindowRef} className="absolute left-[50%] bottom-[65%] z-20 w-[30cqh]">
        ...
        <div ref={educationRef} className="absolute left-[2%] bottom-[13%] z-21">
        ...
        <div ref={skillRef} className="absolute right-[53%] top-[5%] z-20">
          <Window size="custom" closeButtonClassName="text-primary-500">
            <div className={`flex items-center w-full gap-[2cqh] pb-[2cqh]`}>
              <img
                src={ppIgImage}
            ...
            <img
              ...
              className={`block h-[50cqh] rounded-[2cqh] object-cover`}
            />
        ...
        <div ref={experienceRef} className="absolute right-[20%] top-[40%] z-22">
          <Window size="custom" closeButtonClassName="text-primary-500">
            ...
            <img
              ...
              className={`block h-[30cqh] rounded-[2cqh] object-cover`}
            />
