...
export type CategorySectionHandle = {
...
const CategorySection = forwardRef<CategorySectionHandle, CategorySectionProps>(
  function CategorySection({ activeCategory, onBack, isTransitioning }, ref) {
    ...
    return (
      <section
        ref={sectionRef}
        className="absolute inset-0 z-[2] flex items-center justify-center overflow-hidden bg-secondary-950 px-6 py-16 text-secondary-50"
      >
